...
"""Boot is an experimental Sci-Fi text game.
   ...
   To run the game: 
   1) Download the 'Boot_Game_0.96' zip or clone the directory
   2) Make sure Python 3.8 or later is installed
   3) Open the 'Boot_Game_0.96' folder in VS Code and run the file called 'boot_v0_9_6_0.py'

   *** Stable version 0.96 was tested using Windows 10, VS Code command line terminal, and Python 3.8.3 64-bit (conda)
   *** Built exclusively with Python Standard Library
   ...
   This file will be in the root directory of the 'Boot_Game_0.96' folder.

   If you have time, please email Justin and attach your final game score txt file: bootgamepython@gmail.com

   *** Code Notes ***

   Functions, Objects, and While Loop conditions are in alphabetical order.

   Boot_Game_X folder contents:

   boot_v0_9_6_0.py (main game file)
   chest.py (class for Chest objects)
   npc.py (class for NPC objects)
   p_func.py (custom library of printing and character sheet functions)
   room.py (class for Room objects)
   starting_sheet.py (custom library that initializes character_sheet variable)

                    ~Line index for boot_v0_9_6_0.py:

                                           Functions: ~lines 70 to 1,450
                                Object Instantiation: ~lines 1,475 to 1,735
              Intro, Character Creation, Break Point: ~lines 1,785 to 2,185
                                      Main Game Loop: ~lines 2,200 to 3,270

    Questions or Comments? ---> bootgamepython@gmail.com
                                github.com/berwynian
"""
...
from pathlib import Path # for creating directory path objects compatible with PC/Mac/Linux
from ast import literal_eval # used for character loading sequence

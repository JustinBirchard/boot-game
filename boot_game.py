...
"""Boot is an experimental Sci-Fi text game.
   ...
   3) Open the 'Boot_Game_0.97' folder in VS Code and run the file called 'boot_v0.9.7.py'

   *** Stable version 0.97 was tested using Windows 10, VS Code command line terminal, and Python 3.8.5 64-bit (conda)
   ...
   *** Code Notes ***
   ...
   Functions, Objects, and While Loop conditions are in alphabetical order.
                    ...
                    ~Line index for boot_game.py v0.97:
